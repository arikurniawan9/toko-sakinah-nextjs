...
export const useUserForm = (refreshData, defaultRole = '', apiEndpoint = '/api/store-users') => {
  ...
  const openModalForEdit = (user, isAttendantForm = false) => {
    ...
    setFormData({
      ...
      role: isAttendantForm ? 'ATTENDANT' : user.role || '', // Jika form pelayan, tetap ATTENDANT
