...
import { Save, X, User, AtSign, Lock, Mail, Building, Shield } from 'lucide-react';
                    ...
                    <div className={editingUser ? "" : "mb-4"}> {/* Add mb-4 only if not editing */}
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={handleInputChange}
                          className={`w-full px-3 py-2 pl-10 pr-10 border rounded-md shadow-sm focus:outline-none focus:ring-pastel-purple-500 focus:border-pastel-purple-500 sm:text-sm ${
                            darkMode
                              ? 'bg-gray-700 border-gray-600 text-white'
                              : 'border-pastel-purple-300 text-gray-900'
                          }`}
