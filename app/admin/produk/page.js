...
import { Edit, Trash2, Plus, Download, Upload, X, Save, ArrowLeft, Search, Folder } from 'lucide-react';
...
export default function ProductManagement() {
  ...
  // Remove the separate fetchCategories and fetchSuppliers functions since they're now included in products endpoint
  ...
  // Fetch products and related data when dependencies change
  useEffect(() => {
    fetchProducts();
    fetchCategories();
    fetchSuppliers();
  ...
  const handleDelete = async (id) => {
    if (confirm('Apakah Anda yakin ingin menghapus produk ini?')) {
      try {
        ...
        setError('Terjadi kesalahan saat menghapus produk: ' + err.message);
  ...
  const handleSave = async () => {
    if (!formData.name.trim() || !formData.code.trim() || !formData.price) {
      setError('Nama, kode, dan harga produk harus diisi');
      return;
    }
        ...
        <Sidebar>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
              <h1 className={`${darkMode ? 'text-white' : 'text-gray-900'} text-2xl font-bold`}>Manajemen Produk</h1>
              <div className="flex flex-wrap gap-2">
                ...
                <Tooltip content="Tambah produk baru">
                  <button
                    ...
                    className="inline-flex items-center px-3 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-pastel-purple-700 hover:bg-pastel-purple-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pastel-purple-500 min-w-[100px]"
                  >
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Tooltip content="Template Produk">
                  <a 
                    href="/templates/template-produk.xlsx" 
                    download="template-produk.xlsx"
                    className="p-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="flex items-end">
                <div className="flex flex-col items-center">
                  <Tooltip content={`Hapus ${selectedRows.length} produk`}>
                    <button
            ...
            <div className="hidden sm:flex sm:flex-col md:flex md:flex-row md:items-center md:justify-between gap-4 w-full">
              <div>
                <p className={`text-sm ${
                  ...
                  dari <span className="font-medium">{totalProducts}</span> hasil
                </p>
              </div>
              <div>
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                      ...
                      <div className="mt-4 w-full">
                        ...
                        <div className="mb-4">
                          ...
                          >
                            <option className={`${darkMode ? 'bg-gray-700 text-white' : 'bg-white text-gray-900'}`} value="">Pilih Kategori</option>
                        ...
                        <div className="mb-4">
                          ...
                          >
                            <option className={`${darkMode ? 'bg-gray-700 text-white' : 'bg-white text-gray-900'}`} value="">Pilih Supplier</option>
