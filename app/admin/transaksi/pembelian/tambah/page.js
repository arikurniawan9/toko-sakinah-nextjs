  ...
  return (
    <ProtectedRoute requiredRole="ADMIN">
      <main className={`flex-1 p-4 min-h-screen ${darkMode ? 'bg-gray-900 text-gray-100' : 'bg-white text-gray-900'}`}>
        ...
        {error && (
          <div className={`bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4 ${darkMode ? 'dark:bg-red-900/30 dark:border-red-700 dark:text-red-200' : ''}`} role="alert">
        ...
        {successMessage && (
          <div className={`bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-4 ${darkMode ? 'dark:bg-green-900/30 dark:border-green-700 dark:text-green-200' : ''}`} role="alert">
        ...
        <div className={`bg-white p-6 rounded-lg shadow-md mb-6 ${darkMode ? 'bg-gray-800 border-gray-700 text-gray-100' : 'text-gray-900'}`}>
          <h2 className="text-xl font-semibold mb-4">Detail Pembelian</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
              <label htmlFor="supplier" className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">Supplier</label>
              <select
                id="supplier"
            ...
            <div>
              <label htmlFor="purchaseDate" className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">Tanggal Pembelian</label>
              <input
                type="date"
                id="purchaseDate"
                className={`w-full p-2 border rounded-md ${darkMode ? 'bg-gray-700 border-gray-600 text-gray-100' : 'bg-gray-50 border-gray-300 text-gray-900'}`}
          ...
          <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Tambah Produk</h2>
          ...
          <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Item Pembelian</h2>
                ...
                {purchaseItems.length === 0 ? (
                  ...
                  purchaseItems.map((item, index) => (
                    <tr key={item.productId} className={darkMode ? 'hover:bg-gray-700' : 'hover:bg-gray-50'}>
                      ...
                      <td className={`px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300`}>{item.productCode}</td>
